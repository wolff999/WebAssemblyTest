...
UCLASS()
class ROBCOG_API AMyCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	AServerConnection* ServerConnection;
...
protected:
	...
	UFUNCTION(BlueprintCallable, Category = "Request")
		void SetServerConnection(AServerConnection* NewServerConnection);

	UFUNCTION(BlueprintCallable, Category = "Request")
		AServerConnection * GetServerConnection();
	UFUNCTION(BlueprintCallable, Category = "Request")
		void SpawnActor(AActor * a, UClass * u);
